<template>
  <div class="privacy-policy">
    <div class="container mx-auto px-4 py-12 mt-20">
      ...
      <p class="text-sm text-gray-600 mb-6">Last update: 28th December 2023</p>
      ...
      <div class="space-y-8">
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <p>
              1.5 In this policy, "we", "us" and "our" refer to Space 4 Time
              Ltd.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <p>
              ...
              The profile data may be processed for the purposes of enabling and
            ...
            <p>
              2.5 We may process information contained in any enquiry you submit
            ...
            <p>
              2.6 We may process information relating to our customer
              ...
              your name, your employer, your job title or role, your contact
              details, and information contained in communications between us
              and you or your employer. The source of the customer relationship
              data is you or your employer. The customer relationship data may
              be processed for the purposes of managing our relationships with
              customers, communicating with customers, keeping records of those
              communications and promoting our products and services to
              customers. The legal basis for this processing is consent OR our
              legitimate interests, namely the proper management of our customer
              relationships.
            </p>
            <p>
              2.7 We may process information relating to transactions, including
              purchases of goods and services, that you enter into with us
              and/or through our website ("transaction data"). The transaction
              data may include your contact details. The transaction data may be
              ...
              into such a contract and our legitimate interests, namely the
              proper administration of our website and business.
            </p>
            <p>
              2.8 We may process information that you provide to us for the
            ...
            <p>
              2.9 We may process information contained in or relating to any
            ...
            <p>
              2.10 In addition to the specific purposes for which we may process
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <p>
              3.3 We may disclose your personal data to our suppliers or
              subcontractors insofar as reasonably necessary for proper
              administration of our website and business and communications.
            </p>
            <p>
        ...
        <!-- Section 4: Retaining and deleting personal data -->
        <section>
          <h2 class="text-2xl font-semibold mb-4">
          ...
          <div class="space-y-4">
            ...
            <p>
              4.3 Notwithstanding the other provisions of this Section 6, we may
        ...
        <section>
          <h2 class="text-2xl font-semibold mb-4">5. Amendments</h2>
          <div class="space-y-4">
            <p>
            ...
            <p>
              5.3 We may notify you of significant changes to this policy by
              email.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="space-y-4">
            <p>
              6.1 In this Section 6, we have summarised the rights that you have
        ...
        <!-- Section 7: About cookies -->
        <section>
          <h2 class="text-2xl font-semibold mb-4">7. About cookies</h2>
          <div class="space-y-4">
            <p>
        ...
        <!-- Section 8: Cookies that we use -->
        <section>
          <h2 class="text-2xl font-semibold mb-4">8. Cookies that we use</h2>
          <div class="space-y-4">
            <p>
              8.1 We use cookies to help us to analyse the use and performance
              of our website and services.
            </p>
          </div>
        </section>

        <!-- Section 9: Cookies used by our service providers -->
        <section>
          <h2 class="text-2xl font-semibold mb-4">
        ...
        <!-- Section 10: Managing cookies -->
        <section>
          <h2 class="text-2xl font-semibold mb-4">10. Managing cookies</h2>
          <div class="space-y-4">
            <p>
        ...
        <section>
          <h2 class="text-2xl font-semibold mb-4">11. Our details</h2>
          <div class="space-y-4">
            <p>11.1 This website is owned and operated by Space 4 Time Ltd.</p>
            <p>
              11.2 We are registered in Bulgaria with registered office at 10
              Pirin, Omurtag 7900 Bulgaria.
            </p>
            <p>
              11.3 Our principal place of business is at 10 Pirin, Omurtag 7900
              Bulgaria.
            </p>
        ...
        <section>
          ...
          <div class="space-y-4">
            <p>12.1 Our data protection officer's contact details are:</p>
            <p class="font-semibold">Dobromir Steliyanov Ivanov</p>
            <p>10 Pirin, Omurtag 7900 Bulgaria</p>
          </div>
        </section>
      </div>
    </div>
...
export default {
  ...
  head() {
    return {
      title: "Privacy Policy - Space 4 Time Ltd",
      meta: [
        {
          hid: "description",
          name: "description",
          content:
            "Privacy Policy for Space 4 Time Ltd - Learn how we collect, use, and protect your personal data.",
        },
      ],
    };
  },
