        ...
        <div class="col-lg-8 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
          ...
          <div class="row">
            <div class="col-12 mt-4 pt-2">
              ...
              <ul class="list-unstyled mt-3 mb-0">
                <li
                  v-for="item in datas"
                  :key="item"
                  class="list-inline-item text-center m-1 me-2"
                >
                  <a href="javascript:void(0)" class="d-block"
                    ><img
                      :src="item.image"
                      class="rounded-circle avatar avatar-small shadow"
                      alt=""
                  /></a>
            ...
            <div class="col-lg-6 col-12 mt-4 pt-2">
              ...
              <div
                v-for="item in eductions"
                :key="item"
                class="d-flex features align-items-center mt-4 p-3 rounded shadow"
                :class="item.class"
              >
                ...
                <div v-for="item in projects" :key="item" class="col-lg-6 mt-4">
                  ...
                  >
                    ...
                    <div class="card-body content p-4">
                      ...
                      <ul
                        class="list-unstyled d-flex justify-content-between mb-0 mt-3"
                      >
                        <li>
                          <i class="uil uil-tag-alt me-1"></i
                          ><a
                            href="javascript:void(0)"
                            class="text-muted tag"
                            >{{ item.type }}</a
                          >
                        </li>
                        <li>
